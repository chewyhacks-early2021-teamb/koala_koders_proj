...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(route, authenticationService) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"]])], LoginComponent);
    /***/
  },
  ...
  function srcAppPharmPharmComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PharmComponent = /*#__PURE__*/function () {
      function PharmComponent(agoraService, firestore) {
        var _this = this;
        ...
        firestore.collection('Products').get().forEach(function (cols) {
          cols.docs.forEach(function (snapshot) {
            _this.list_of_products.push(_this.retrieve_product_info(snapshot, snapshot.id));
          });
        }); // subscribe(snapshot => {
      ...
      _createClass(PharmComponent, [{
        ...
        value: function recommendProduct(product_id, product) {
          var ref = this.firestore.collection('Users').doc(this.userID);
          ref.update({
            recommended_products: firebase_app__WEBPACK_IMPORTED_MODULE_6__["firestore"].FieldValue.arrayUnion(product_id)
          });
          this.remove(product);
        }
      }, {
        key: "unrecommendProduct",
        value: function unrecommendProduct(product_id) {
          var ref = this.firestore.collection('Users').doc(this.userID);
          ref.update({
            recommended_products: firebase_app__WEBPACK_IMPORTED_MODULE_6__["firestore"].FieldValue.arrayRemove(product_id)
          });
        }
      }, {
        key: "retrieve_product_info",
        value: function retrieve_product_info(snapshot, id) {
          var product = {
            title: "",
            category: "",
            price: "",
        ...
        value: function init() {
          ...
          this.localStream.init(function () {
            ...
            _this4.localStream.play('agora_local');
        ...
        value: function assignClientHandlers() {
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].Error, function (error) {
            ...
            if (error.reason === 'DYNAMIC_KEY_TIMEOUT') {
              _this5.client.renewChannelKey('', function () {
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].RemoteStreamAdded, function (evt) {
            ...
            _this5.client.subscribe(stream, {
              audio: true,
              video: true
            }, function (err) {
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].RemoteStreamSubscribed, function (evt) {
            ...
            var id = _this5.getRemoteId(stream);

            if (!_this5.remoteCalls.length) {
              _this5.remoteCalls.push(id);
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].PeerLeave, function (evt) {
            ...
            if (stream) {
              stream.stop();
              _this5.remoteCalls = _this5.remoteCalls.filter(function (call) {
                return call !== "".concat(_this5.getRemoteId(stream));
              });
        ...
        value: function remove(item) {
          // var id = item.id
          var index = this.list_of_products.indexOf(item);
          this.list_of_managed_products.push(item); // const indexInID = this.list_of_products_ids.indexOf(id);
        ...
        key: "undo_rec_item",
        value: function undo_rec_item(item) {
          var index = this.list_of_managed_products.indexOf(item);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_agora__WEBPACK_IMPORTED_MODULE_3__["NgxAgoraService"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestore"]])], PharmComponent);
    /***/
  },
  ...
  function srcAppServicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthenticationService = /*#__PURE__*/function () {
      function AuthenticationService(route, angularFireAuth) {
      ...
      _createClass(AuthenticationService, [{
        key: "SignIn",
        value: function SignIn(email, password, mode) {
          var _this6 = this;

          this.angularFireAuth.auth.signInWithEmailAndPassword(email, password).then(function (res) {
            console.log('You are Successfully logged in!');

            _this6.route.navigate([mode]);

            _this6.user_uid = res.user.uid;
          })["catch"](function (err) {
    ...
    AuthenticationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"]])], AuthenticationService);
    /***/
  },
  ...
  function srcAppUserUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserComponent = /*#__PURE__*/function () {
      function UserComponent(authenticationService, agoraService, firestore) {
        var _this7 = this;
        ...
        this.user_uid = this.authenticationService.user_uid; // firestore.doc('Users/'+this.user_uid).get().subscribe(snapshot => {
        ...
        firestore.doc('Users/' + this.user_uid).snapshotChanges().subscribe(function (snapshot) {
          console.log('we are liveee');
          _this7.list_of_recommended_products = [];
          _this7.list_of_recommended_products_ids = snapshot.payload.data()['recommended_products'];

          _this7.list_of_recommended_products_ids.forEach(function (product_id) {
            console.log("product Id" + product_id);

            _this7.list_of_recommended_products.push(_this7.retrieve_product_info(product_id));
          });
        });
        this.uid = Math.floor(Math.random() * 100);
        this.client = this.agoraService.createClient({
      ...
      _createClass(UserComponent, [{
        key: "retrieve_product_info",
        value: function retrieve_product_info(id) {
          var product = {
            title: "",
            category: "",
            price: "",
          ...
          var ref = this.firestore.doc('Products/' + id).get().subscribe(function (snapshot) {
            if (snapshot.data().title) {
              product.title = snapshot.data().title;
            }
        ...
        value: function init() {
          ...
          this.localStream.init(function () {
            ...
            _this10.localStream.play('agora_local');
        ...
        value: function assignClientHandlers() {
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].Error, function (error) {
            ...
            if (error.reason === 'DYNAMIC_KEY_TIMEOUT') {
              _this11.client.renewChannelKey('', function () {
                return console.log('Renewed the channel key successfully.');
              }, function (renewError) {
                return console.error('Renew channel key failed: ', renewError);
              });
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].RemoteStreamAdded, function (evt) {
            ...
            _this11.client.subscribe(stream, {
              audio: true,
              video: true
            }, function (err) {
              console.log('Subscribe stream failed', err);
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].RemoteStreamSubscribed, function (evt) {
            ...
            var id = _this11.getRemoteId(stream);

            if (!_this11.remoteCalls.length) {
              _this11.remoteCalls.push(id);
          ...
          this.client.on(ngx_agora__WEBPACK_IMPORTED_MODULE_3__["ClientEvent"].PeerLeave, function (evt) {
            ...
            if (stream) {
              stream.stop();
              _this11.remoteCalls = _this11.remoteCalls.filter(function (call) {
                return call !== "".concat(_this11.getRemoteId(stream));
              });
              console.log("".concat(evt.uid, " left from this channel"));
            }
          });
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_authentication_service__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"], ngx_agora__WEBPACK_IMPORTED_MODULE_3__["NgxAgoraService"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestore"]])], UserComponent);
    /***/
  },
